...
### 출력 
 ...
 <p>i-1, i, i+1 을 i, i+1, i+2로 바꾸어 변경해야할 전구가 있으면 스위치를 키면서 이동하는 그리디 탐색을 한다.</p>
 <p>첫번 째 전구를 켜고 끌 수 없으므로 첫 스위치를 누른 경우, 안누른 경우로 나누어 2번 탐색한다. 그 후 최소값 출력</p>
